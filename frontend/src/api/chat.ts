...
export interface Message {
  ...
  export const fetchMessages = async (chatId: string): Promise<{ messages: Message[]; isThreadCreated: boolean; currentThreadId: string | null }> => {
  ...
  export const sendMessage = async (threadId: string, message: string): Promise<Message> => {
    try {
