...
urlpatterns = [
    path('streaming-response/<int:thread_id>/', views.chat_with_model_stream, name='chat_with_model_stream'),
    ...
    path('threads/<int:thread_id>/update-title/', views.update_thread_title, name='update_thread_title'),
